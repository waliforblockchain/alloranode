...
echo
echo -e "${BOLD}${DARK_YELLOW}Operating System : Debian 11${RESET}"
...
echo
echo "${BOLD}${DARK_YELLOW}Follow me on Telegram @earnwithwali for more one click node run guides !!${RESET}"
echo
